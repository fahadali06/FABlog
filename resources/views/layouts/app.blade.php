...
<html lang="en">
    <head>
        ...
        <!-- MetisMenu CSS -->
        <link href="{{ asset('public/assets/admin//vendor/metisMenu/metisMenu.min.css') }}" rel="stylesheet">
        ...
        <!-- Custom Fonts -->
        <link href="{{ asset('public/assets/admin//vendor/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css">
    ...
    <body>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="{{ url('admin/blog/category') }}"><i class="fa fa-table fa-fw"></i> Category</a>
                            </li>
        ...
        <script src="{{ asset('public/assets/admin//vendor/metisMenu/metisMenu.min.js') }}"></script>
