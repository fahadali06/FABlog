        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {{ Form::open(['url' => url('admin/user/management/update', [$user->id]), 'mehtod' => 'POST', 'id' => 'FormAdd', 'enctype' => 'multipart/form-data']) }}
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::select('status', ['Yes' => 'Active', 'No' => 'Inactive'], $user->status, ['class' => 'form-control']) }}
                    </div>
